...
const Landing = () => {
  ...
  return (
    <div className="bg-white text-gray-900 overflow-hidden">
      ...
      {/* Hero Section */}
      <div
        className="relative flex items-center justify-center min-h-[100vh] bg-cover bg-center pt-5 md:pt-5"
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link
              to="/register"
              className="bg-amber-500 px-10 py-4 text-lg font-bold rounded-full shadow-md hover:bg-amber-600 transition"
            >
              <FontAwesomeIcon icon={faUserPlus} className="mr-2" /> Get Started
            </Link>
            <Link
              to="/login"
              className="bg-blue-700 px-10 py-4 text-lg font-bold rounded-full shadow-md hover:bg-blue-800 transition"
            >
      ...
      {services.map((service, i) => (
        <section
          key={i}
          className={`py-20 ${i % 2 === 0 ? "bg-gray-50" : "bg-white"} px-6 md:px-16 lg:px-24`}
        >
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <Link
                to="/services"
                className="inline-block mt-2 px-6 py-2 bg-amber-500 text-gray-900 font-semibold rounded-full shadow hover:bg-amber-600 transition"
              >
                Learn More
              </Link>
            </div>
      ...
      {/* Testimonials */}
      <section className="py-20 bg-gradient-to-r from-blue-50 via-white to-blue-50 px-6 md:px-16 lg:px-24">
      ...
      {/* CTA */}
      <section
        className="relative py-20 bg-cover bg-center text-center px-6 md:px-16 lg:px-24"
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <Link
            to="/register"
            className="bg-amber-500 text-gray-900 px-10 py-4 text-lg font-bold rounded-full shadow-md hover:bg-amber-600 transition"
          >
            Join Now
          </Link>
        </div>
